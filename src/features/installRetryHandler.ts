...
// 相关: [src/uploader/optimistic.ts()](src/uploader/optimistic.ts:1), [src/features/installPasteHandler.ts()](src/features/installPasteHandler.ts:1)
...
export function installRetryHandler(
  ...
  return {
    uninstall: () => {
      try { containerEl.removeEventListener('mousedown', onMouseDown, true); } catch {}
    }
  };
}
