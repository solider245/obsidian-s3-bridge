...
// 相关: [src/objectKey/makeKey.ts()](src/objectKey/makeKey.ts:1), [src/commands/registerCommands.ts()](src/commands/registerCommands.ts:1), [src/paste/installPasteHandler.ts()](src/paste/installPasteHandler.ts:1)
