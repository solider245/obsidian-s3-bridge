// 概述: 生成 S3 对象键，支持可配置日期前缀与 uploadId 优先命名，保持与 main.ts 现有逻辑一致。
...
// 相关: [src/mime/extension.ts()](src/mime/extension.ts:1), [src/commands/registerCommands.ts()](src/commands/registerCommands.ts:1), [src/paste/installPasteHandler.ts()](src/paste/installPasteHandler.ts:1)
